...
from Testing.Seminar_2.hw2.Car import Car
from Testing.Seminar_2.hw2.Motorcycle import Motorcycle
...
class TestVehicle(unittest.TestCase):
    ...
    def test_speed_test_drive_moto(self):
