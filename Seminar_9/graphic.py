...
from engine import dictionary, create_field, draw_field, game_over
...
def title():
    title_field = draw_field('530x170', 'black')
    lbl = tk.Label(
        title_field,
        text='Крестики - нолики',
        font=('Terminator Cyr 4', 22),
        fg='yellow', bg='black',
    )
